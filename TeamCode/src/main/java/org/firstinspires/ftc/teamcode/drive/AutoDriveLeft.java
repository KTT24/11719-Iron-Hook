...
@Autonomous(name = "AutoDriveLeft", group = "Testing OpModes")
@Config
public class AutoDriveLeft extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Trajectory traj1 = drive.trajectoryBuilder(startPose)
                .lineTo(new Vector2d(-35,-35), SampleMecanumDrive.getVelocityConstraint(DriveConstants.MAX_VEL,DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH),SampleMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL)).build();
                // .lineToLinearHeading(new Pose2d(-35, -35, Math.toRadians(0)), SampleMecanumDrive.getVelocityConstraint(DriveConstants.MAX_VEL, DriveConstants.MAX_ANG_VEL, 15), SampleMecanumDrive.getAccelerationConstraint(DriveConstants.MAX_ACCEL))
